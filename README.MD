...
#### 1.4.1 MD5 签名方法
###### 将需要上送的所有字段进行字典序排序，转成JSON字符创。对JSON字符串拼接签名密钥得到待签名字符创。对待签名字符串进行md5得到sign值。==测试环境中的签名密钥为：123456==
...
则JSON字符串为：{"aaa":"123","bbb":"345","ccc":"234"}，待签名字符串为：{"aaa":"123","bbb":"345","ccc":"234"}&sign_key=123456 做md5 加密之后结果是：a77c02019fb0f0ea2cdacfcea06a67ee，此即为sign值
最终发送的结果是：
{"aaa":"123","bbb":"345","ccc":"234","sign":"a77c02019fb0f0ea2cdacfcea06a67ee"}
### 1.5 声明
#### 1.5.1 是否必填标记
标记符号|释义
---|---
...
## 2.扫码支付
### 2.1 测试环境地址：http://192.168.124.15:8080/scanCodePay
### 2.2 正式环境地址：
...
## 3.条码支付？
### 3.1 测试环境地址：192.168.124.15:8080/barCodePay
### 3.2 正式环境地址：
中文名称|属性名称|类型|长度|是否必填|默认值|备注
---|---|---|---|---|---|---
版本号|version|String|10|F|1.0|默认版本1.0
